...
extern void vdev_cleanup_old_sm_logs(vdev_t *, dmu_tx_t *);
extern void metaslab_load_vdev_spacemap(metaslab_t *);
...
extern space_map_t *vdev_get_syncing_log_sm(vdev_t *vd, dmu_tx_t *tx);
