...
#define	dn_max_iter		dn_u._conditional._max_iter
...
#define	DT_NODE_WHILE	23	/* while statement */
...
extern dt_node_t *dt_node_while(dt_node_t *, dt_node_t *, uintmax_t);

extern dt_node_t *dt_node_last(dt_node_t *);
