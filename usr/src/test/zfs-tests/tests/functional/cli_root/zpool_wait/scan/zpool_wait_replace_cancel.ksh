...
# 2. Modify tunable so that resilver runs slowly enough so that it won't
#    complete while test is running.
...
log_must mdb_ctf_set_int zfs_scan_max_blks_per_txg 8
