...
function cleanup
{
	...
	[[ $default_mem_limit ]] && log_must mdb_ctf_set_int \
...
default_mem_limit=$(mdb_get_hex zfs_spa_discard_memory_limit)
log_must mdb_ctf_set_int zfs_spa_discard_memory_limit 0t32
