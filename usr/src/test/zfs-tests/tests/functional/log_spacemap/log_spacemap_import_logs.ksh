...
function cleanup
{
	log_must mdb_ctf_set_int zfs_keep_log_spacemaps_at_export 0t0
	log_must mdb_ctf_set_int metaslab_debug_load 0t0
...
log_must mkfile -n 128M $TESTDISK
...
log_must mdb_ctf_set_int zfs_keep_log_spacemaps_at_export 0t1
...
log_must mdb_ctf_set_int metaslab_debug_load 0t1
